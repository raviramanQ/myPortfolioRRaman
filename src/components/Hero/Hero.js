      ...
      <div className="home-grid">
        <div className="home-content">
          ...
          <p className="home-description">
            ...
            designing scalable web applications, REST APIs, cloud solutions,
            and AI-powered products using modern JavaScript technologies.
          </p>
<br/>
          <h4 className="amber">
            Node.js • React • NestJS • MongoDB • Express • AWS • GenAI • AgenticAI • Docker • PHP • MySQL
          </h4>
<br/>
          ...
          <div className="home-social">
            <a
              href="https://github.com/raviramanQ"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaGithub />
            ...
            <a
              href="https://linkedin.com/in/ravi-raman-56604a184"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaLinkedin />
      ...
      <div className="home-stats">
        ...
        <div className="stat">
          ...
          <span className="stat-label">CONTINUOUS LEARNING</span>
        </div>
      </div>
    </div>
